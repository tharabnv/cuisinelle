...
<div id="help-panel" class="panel-left">
    ...
    <div class="panel-aside">
        <h4><?php printf( esc_html__( 'View Our %1$s Demo', 'blossom-recipe' ), BLOSSOM_RECIPE_THEME_NAME ); ?></h4>
        <p><?php esc_html_e( 'Visit the demo to get more ideas about our theme design.', 'blossom-recipe' ); ?></p>
        <a class="button button-primary" href="<?php echo esc_url( 'https://blossomthemes.com/theme-demo/?theme=' . BLOSSOM_RECIPE_THEME_TEXTDOMAIN  ); ?>" title="<?php esc_attr_e( 'Visit the Demo', 'blossom-recipe' ); ?>" target="_blank">
